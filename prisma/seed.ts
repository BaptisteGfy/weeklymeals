...
async function seed() {
  ...
  const libraryRecipes = [
    ...
    },
    {
      ...
      description:
        'Des pancakes épais et moelleux, parfaits pour un brunch ou un petit-déjeuner du week-end.',
    ...
    },
    {
      ...
      ingredients: [
        {
          nameFr: 'Pâte brisée',
          nameEn: 'Shortcrust pastry',
          quantity: 1,
          unit: 'unit' as IngredientUnit,
          category: 'pastry' as const,
        },
        {
          nameFr: 'Lardons fumés',
          nameEn: 'Smoked bacon lardons',
          quantity: 200,
          unit: 'g' as IngredientUnit,
          category: 'deli' as const,
        },
        {
          nameFr: 'Crème fraîche épaisse',
          nameEn: 'Heavy cream',
          quantity: 200,
          unit: 'ml' as IngredientUnit,
          category: 'dairy' as const,
    ...
    },
    {
      ...
      ingredients: [
        ...
        {
          nameFr: "Filets d'anchois",
          nameEn: 'Anchovy fillets',
          quantity: 30,
          unit: 'g' as IngredientUnit,
          category: 'fish' as const,
        },
    ...
    },
    {
      ...
      imageUrl:
        'https://images.unsplash.com/photo-1777157508989-6c0faa98ba46?q=80&w=1427&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      description:
        'Une tarte aux pommes classique et élégante, avec des lamelles dorées disposées en rosace sur une pâte croustillante.',
    ...
    },
    {
      ...
      ingredients: [
        ...
        {
          nameFr: 'Tomates pelées en boîte',
          nameEn: 'Canned peeled tomatoes',
          quantity: 400,
          unit: 'g' as IngredientUnit,
          category: 'vegetables' as const,
        },
    ...
    },
    {
      ...
      ingredients: [
        ...
        {
          nameFr: 'Parmesan râpé',
          nameEn: 'Grated parmesan',
          quantity: 60,
          unit: 'g' as IngredientUnit,
          category: 'dairy' as const,
        },
    ...
    },
    {
      ...
      description:
        'La pâte à crêpes inratable : fine, souple et légèrement dorée. Idéale sucrée ou salée.',
      category: 'breakfast' as const,
      servings: 4,
      prepTimeMinutes: 10,
      cookTimeMinutes: 20,
