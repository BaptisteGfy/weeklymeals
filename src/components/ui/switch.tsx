...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        'peer group/switch aria-invalid:border-destructive aria-invalid:ring-destructive/20 data-unchecked:bg-input/90 relative inline-flex shrink-0 items-center rounded-full border-2 transition-all outline-none after:absolute after:-inset-x-3 after:-inset-y-2 focus-visible:border-olive-500 focus-visible:ring-3 focus-visible:ring-olive-500/30 aria-invalid:ring-3 data-checked:border-olive-500 data-checked:bg-olive-500 data-disabled:cursor-not-allowed data-disabled:opacity-50 data-unchecked:border-transparent data-[size=default]:h-5 data-[size=default]:w-11 data-[size=sm]:h-4 data-[size=sm]:w-7',
        className,
      )}
      {...props}
    >
